<template>
    <div class="container">
        ...
        <p class="font-weight-bold">By using Downstream you're also bound to YouTube's Terms of Service which can be
            found <a href="https://www.youtube.com/t/terms">here</a></p>
        ...
        <p>This website is operated by Downstream. Throughout the site, the terms “we”, “us” and “our” refer to
            Downstream. Downstream offers this website, including all information, tools and services available from
        ...
        <p>We do not guarantee, represent or warrant that your use of our service will be uninterrupted, timely, secure
            ...
            In no case shall Downstream, our directors, officers, employees, affiliates, agents, contractors, interns,
        ...
        <p>You agree to indemnify, defend and hold harmless Downstream and our parent, subsidiaries, affiliates,
        ...
        Questions about the Terms of Service should be sent to us at downstream@tecdrip.com
    </div>
</template>
